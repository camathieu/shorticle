...
import gg.root.utils.RandomStringGenerator;
...
public class Shorticle extends Verticle {
    Logger log;
    Random rand;
    ...
    public void start() {
        ...
        hashkey = container.config().getString("hashkey", "shorticle.url_store");
        ...
        vertx.eventBus().registerHandler("shorticle.get", new Handler<Message<JsonObject>>() {
            @Override
            public void handle(Message<JsonObject> message) {
                String shorturl = message.body().getString("url");
                JsonObject result = new JsonObject();

                log.info("Shorticle get " + shorturl);
        ...
        vertx.eventBus().registerHandler("shorticle.set", new Handler<Message<JsonObject>>() {
            @Override
            public void handle(Message<JsonObject> message) {
                ...
                if (!isValidURL(longurl)) {
                    ...
                    log.info("Shorticle set " + longurl);
