...
angular.module('shorticle', ['ngRoute', 'dialog', 'ngClipboard', 'knalli.angular-vertxbus'])
	.config(function($routeProvider) {
		$routeProvider
			.when('/', { controller:ShorticleCtrl, templateUrl:'static/partials/view.html', reloadOnSearch: false})
...
function ShorticleCtrl($scope, $dialog, $route, $location, vertxEventBusService) {
    ...
    $scope.shorten = function () {
        ...
        eb.send("shorticle.set", { url: $scope.longurl })
